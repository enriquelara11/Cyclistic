...
### Scenario
You are a junior data analyst working for the marketing analyst team for Cyclistic. The Director of Marketing Lily Moreno has instructed you to find the differences between casual and annual riders and to report your findings to the marketing team, as well as to provide some recommendations on how to transform casual riders to annual riders.  
